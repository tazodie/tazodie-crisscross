...
load_little_32 (cc_uint32_t *addr)
{
    cc_uint32_t value;
...
static void
MD5Transform (cc_uint32_t a, cc_uint32_t b, cc_uint32_t c, cc_uint32_t d,
              MD5_CTX *ctx, const cc_uint8_t block[64])
{
    /*
     * general optimization:
     *
...
static void
Encode (cc_uint8_t * output, const cc_uint32_t * input,
        size_t input_len)
{
    size_t i, j;
