...
namespace CrissCross
{
	...
	enum Errors
	{
		CC_ERR_BADPARAMETER = -1000,                  /*! \brief< One of the parameters passed to the function was not valid. */
		CC_ERR_NOT_IMPLEMENTED,
		CC_ERR_FILE_OPEN,                             /*! \brief< The specified file could not be opened. */
		CC_ERR_WRITE,                                 /*! \brief< The buffer could not be written to. */
		CC_ERR_INTERNAL,                              /*! \brief< A call inside the function failed. */
		CC_ERR_INVALID_CALL = -500,                   /*! \brief< The function call was invalid. */
		CC_ERR_INVALID_BUFFER = -499,                 /*! \brief< The buffer was NULL (file not opened?) */
		CC_ERR_INCOMPATIBLE_BUFFER = -498,            /*! \brief< The buffer was incompatible (i.e. reading unicode data on a non-unicode buffer). */
		CC_ERR_EPERM,
		CC_ERR_ENOENT,
		CC_ERR_ESRCH,
		CC_ERR_EINTR,
